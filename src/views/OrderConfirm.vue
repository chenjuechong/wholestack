          ...
          <div class="item-list-wrap confirm-item-list-wrap">
            <div class="cart-item order-item">
              ...
              <ul class="cart-item-list">
                  <li v-for="(item,index) in itemChecked" :key="index">
                      <!-- 商品图片和图片名称 -->
...
export default {
   data() {
      return {
          ...
          subTotal: 0, // 订单总金额（是购物车选择的总金额）

          orderTotal:0 , // 总金额+配送费-折扣+税费 = orederTotal 用户需要支付的金额，默认为0
