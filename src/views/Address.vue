<template>
	<div>
				...
				<div class="checkout-addr">
					...
					<div class="addr-list-wrap">
						...
						<div class="shipping-addr-more">
							<a class="add-more-btn up-down-btn" href="javascript:;" @click="expand" v-bind:class="{'open':limit>3}">
								more
								<i class="i-up-down">
		...
		<!-- 模态框 -->
		<modal :mdShow="isMoShow" @close="closeModal">
			<p slot="message">
			您是否确认要删除此地址?
			</p>
			 <div slot="btnGroup">
...
<script>
	...
	export default {
		...
		methods: {
			...
			delAddressConfirm(addressId) { //点击删除 模态框出现
				this.isMdShow = true;
